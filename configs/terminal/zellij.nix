      ...
      default_tab_template {
        ...
        pane size=1 borderless=true {
          ...
          plugin location="file://${pkgs.zjstatus}/bin/zjstatus.wasm" {
            ...
            mode_normal        "#[bg=#${colors.base03},fg=#${colors.base01},bold] NORMAL#[bg=#${colors.base03},fg=#${colors.base03}]█"
            mode_locked        "#[bg=#${colors.base08},fg=#${colors.base01},bold] LOCKED #[bg=#${colors.base03},fg=#${colors.base08}]█"
            mode_resize        "#[bg=#${colors.base09},fg=#${colors.base01},bold] RESIZE#[bg=#${colors.base03},fg=#${colors.base09}]█"
            mode_pane          "#[bg=#${colors.base0E},fg=#${colors.base01},bold] PANE#[bg=#${colors.base03},fg=#${colors.base0E}]█"
            mode_tab           "#[bg=#${colors.base0B},fg=#${colors.base01},bold] TAB#[bg=#${colors.base03},fg=#${colors.base0B}]█"
            mode_scroll        "#[bg=#${colors.base04},fg=#${colors.base01},bold] SCROLL#[bg=#${colors.base03},fg=#${colors.base04}]█"
            mode_enter_search  "#[bg=#${colors.base0A},fg=#${colors.base01},bold] ENT-SEARCH#[bg=#${colors.base03},fg=#${colors.base0A}]█"
            mode_search        "#[bg=#${colors.base0A},fg=#${colors.base01},bold] SEARCHARCH#[bg=#${colors.base03},fg=#${colors.base0A}]█"
            mode_rename_tab    "#[bg=#${colors.base0C},fg=#${colors.base01},bold] RENAME-TAB#[bg=#${colors.base03},fg=#${colors.base0C}]█"
            mode_rename_pane   "#[bg=#${colors.base0C},fg=#${colors.base01},bold] RENAME-PANE#[bg=#${colors.base03},fg=#${colors.base0C}]█"
            mode_session       "#[bg=#${colors.base0F},fg=#${colors.base01},bold] SESSION#[bg=#${colors.base03},fg=#${colors.base0F}]█"
            mode_move          "#[bg=#${colors.base0B},fg=#${colors.base01},bold] MOVE#[bg=#${colors.base03},fg=#${colors.base0B}]█"
            mode_prompt        "#[bg=#${colors.base05},fg=#${colors.base01},bold] PROMPT#[bg=#${colors.base03},fg=#${colors.base05}]█"
            mode_tmux          "#[bg=#${colors.base07},fg=#${colors.base01},bold] TMUX#[bg=#${colors.base03},fg=#${colors.base07}]█"
